...
<page backtop="30mm" backbottom="10mm" backleft="5mm" backright="10mm" style="font-size: 12pt" backimgx="center" backimgy="bottom" backimgw="100%">
     <page_header>
    ...
    <?php
        ...
        $lista = $_GET["grado"];
        $query=mysql_query("SELECT * FROM alumnos WHERE id_grado = '$lista' ORDER BY id_alumno");
        $i=1;
